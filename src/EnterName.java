 ...
 */
public class EnterName {       //AccountLoginAndCreation, but that's really wordy
    public static void enterName(UserAccount account) throws Exception {       //accepts user input to login and create accounts
        account.name = null;
